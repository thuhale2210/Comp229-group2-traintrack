        ...
        <tbody>
          {workoutHistory.map((workout, index) => (
            <tr key={index} className="border-b">
              <td className="py-5 px-4">{workout.date}</td>
              <td className="py-5 px-4">{`${workout.time} `}</td>
              <td className="py-5 px-4">{workout.focusArea}</td>
              <td className="py-5 px-4">{workout.trainer}</td>
              <td className="py-5 px-4">{`${workout.duration} minute${workout.duration > 1 ? 's' : ''}`}</td>
              <td className="py-5 px-4">{workout.specialRequest}</td>
            </tr>
          ))}
        </tbody>
      </table>
